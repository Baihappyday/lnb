...
import static com.example.login.widget.IndicatorDotView.DEFAULT_DOT_COLOR;
import static com.example.login.widget.IndicatorDotView.DEFAULT_DOT_RADIUS_DIP;
import static com.example.login.widget.ViewPagerIndicator.DEFAULT_DOT_PADDING_DIP;
...
class IndicatorDotPathView extends ViewGroup {
    ...
    @NonNull
    private final com.example.login.widget.IndicatorDotView startDot;
    @NonNull
    private final com.example.login.widget.IndicatorDotView endDot;
    ...
    IndicatorDotPathView(@NonNull Context context) {
        ...
        this.startDot = new com.example.login.widget.IndicatorDotView(context);
        this.endDot = new com.example.login.widget.IndicatorDotView(context);
    ...
    Animator retreatConnectedPathAnimator(@PathDirection int pathDirection) {
        final com.example.login.widget.IndicatorDotView fromDot = pathDirection == PATH_DIRECTION_RIGHT ? startDot : endDot;
        final com.example.login.widget.IndicatorDotView toDot = pathDirection == PATH_DIRECTION_LEFT ? startDot : endDot;
        return retreatConnectedPathAnimator(fromDot, toDot);
    }

    @NonNull
    private Animator retreatConnectedPathAnimator(@NonNull com.example.login.widget.IndicatorDotView fromDot,
                                                  @NonNull com.example.login.widget.IndicatorDotView toDot) {
     ...
     */
    @NonNull
    private Animator retreatDotAnimator(@NonNull final com.example.login.widget.IndicatorDotView retreatingDot,
                                        final float toX,
                                        final float toY,
     ...
     */
    private static class DotPathSegment extends com.example.login.widget.IndicatorDotView {
