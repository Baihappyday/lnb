    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Request request = new Request.Builder()
                                    // 指定访问的服务器地址
                                    .url("http://192.168.232.1:9090/register/communityusers")
                                    //.post(RequestBody2)
                            ...
                            if(parseJSONWithJSONObject(responseData).equals("注册成功")){
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(Community_erollActivity.this,"用户名已存在!",Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        } catch (Exception e) {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Community_erollActivity.this,"网络错误",Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
        ...
        return_login.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(Community_erollActivity.this, Community_loginActivity.class);//跳转至登录界面
                //启动
                startActivity(i);
            }
        });
